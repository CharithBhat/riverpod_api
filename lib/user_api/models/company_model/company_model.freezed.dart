...
abstract class $CompanyModelCopyWith<$Res> {
  ...
  $Res call({String id, String catchPhrase, String bs});
}
...
class _$_CompanyModel implements _CompanyModel {
  const _$_CompanyModel(
      {required this.id, required this.catchPhrase, required this.bs});
...
// so the string needs to be there
  ...
  @override
  String toString() {
    return 'CompanyModel(id: $id, catchPhrase: $catchPhrase, bs: $bs)';
  }
...
abstract class _CompanyModel implements CompanyModel {
  ...
  @override // so the string needs to be there
  String get id;
  @override
